...
class TestCase(TestCase):
    ...
    def test_basic_group_settings(self):
        session = nonrealtimetools.Session()
        with session.at(0):
            group = session.add_group(duration=20)
        with session.at(5):
    ...
    def test_basic_synth_settings(self):
        session = nonrealtimetools.Session()
        with session.at(10):
    ...
    def test_basic_node_order(self):
        session = nonrealtimetools.Session()
        ...
        assert session.to_lists() == [
            [0.0, [
                ...
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1001, 1, 1000,
                    'frequency', 1111],
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1002, 1, 1000,
                    'frequency', 2222],
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1003, 1, 1000,
                    'frequency', 3333]]],
            [20.0, [
                ['/n_free', 1000],
                ['/n_set', 1001, 'gate', 0],
        ...
        assert session.to_lists() == [
            ...
            [10.0, [
                ...
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1005, 1, 1004,
                    'frequency', 1111],
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1006, 1, 1004,
                    'frequency', 2222],
                ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1007, 1, 1004,
                    'frequency', 3333],
                ['/n_free', 1000],
                ['/n_set', 1001, 'gate', 0],
                ['/n_set', 1002, 'gate', 0],
