...
class _CTimespan(object):
    ...
    def from_timespan(cls, timespan):
        ...
        elif start_offset == NegativeInfinity:
            start_offset = float('-inf')
        else:
        ...
        elif stop_offset == NegativeInfinity:
            stop_offset = float('-inf')
        else:
    ...
    def intersects_timespan(self, expr):
        return (
            (
                ...
                self.start_offset <= expr.start_offset and
                expr.start_offset < self.stop_offset
                )
            )
