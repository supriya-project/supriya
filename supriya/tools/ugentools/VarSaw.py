...
class VarSaw(PureUGen):
    ...
    def frequency(self):
        ...
        ::
            ...
            >>> ugentools.VarSaw.ar(frequency=440.0).frequency
            440.0
    ...
    def initial_phase(self):
        r'''Gets initial phase input of VarSaw.

        ::

            >>> ugentools.VarSaw.ar(initial_phase=0.5).initial_phase
            0.5
    ...
    def width(self):
        ...
        ::
            ...
            >>> ugentools.VarSaw.ar(width=0.25).width
            0.25
