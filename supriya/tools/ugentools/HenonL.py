...
class HenonL(UGen):
    ...
    def ar(
        ...
        """
        Constructs an audio-rate HenonL.
    ...
    def frequency(self):
        """
        Gets `frequency` input of HenonL.
