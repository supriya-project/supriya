...
class BufDelayL(BufDelayN):
    ...
    def ar(
        ...
        r'''Create an audio-calculation_rate buffer-based linear-interpolating delay line.
    ...
    def kr(
        ...
        r'''Create a control-calculation_rate buffer-based linear-interpolating delay line.
