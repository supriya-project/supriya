...
class BufAllpassL(BufAllpassN):
    ...
    def ar(
        ...
        r'''Create an audio-calculation_rate buffer-based linear-interpolating allpass
        delay line.
    ...
    def kr(
        ...
        r'''Create a control-calculation_rate buffer-based linear-interpolating allpass
        delay line.
