...
class BufAllpassN(PureUGen):
    ...
    def ar(
        ...
        r'''Create an audio-calculation_rate buffer-based non-interpolating allpass delay
        line.
    ...
    def kr(
        ...
        r'''Create a control-calculation_rate buffer-based non-interpolating allpass delay
        line.
