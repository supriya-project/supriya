...
class TestCase(unittest.TestCase):
    ...
    def test_manual_incommunicado_ppar_01(self):
        lists, deltas = self.manual_incommunicado(self.ppar_01, 10)
        assert lists == [
            [10, [
    ...
    def test_manual_communicado_ppar_01(self):
        player = patterntools.RealtimeEventPlayer(
            self.ppar_01,
            server=self.server,
            )
    ...
    def test_automatic_communicado_ppar_01(self):
        self.ppar_01.play(server=self.server)
        time.sleep(4)
