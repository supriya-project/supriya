...
class DemandEnvGen(UGen):
    ...
    def ar(
        ...
        r'''Constructs an audio-rate DemandEnvGen.
    ...
    def kr(
        ...
        r'''Constructs a control-rate DemandEnvGen.
    ...
    @property
    def duration(self):
        r'''Gets `duration` input of DemandEnvGen.
    ...
    @property
    def level_bias(self):
        r'''Gets `level_bias` input of DemandEnvGen.
