# -*- encoding: utf-8 -*-
from supriya.tools.ugentools.BLowCut import BLowCut


class LRLowCut(BLowCut):
    r'''

    ::

        >>> lrlow_cut = ugentools.LRLowCut.(
        ...     frequency=None,
        ...     max_order=5,
        ...     order=2,
        ...     source=None,
    ...
    def ar(
        ...
        r'''Constructs an audio-rate LRLowCut.
    ...
    def kr(
        ...
        r'''Constructs a control-rate LRLowCut.
    ...
    @property
    def order(self):
        r'''Gets `order` input of LRLowCut.
