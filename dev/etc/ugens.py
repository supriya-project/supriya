...
for ugen_name, ugen_definition in ugens.items():
    if (
        "methods" in ugen_definition
        or "parent" not in ugen_definition
        or ugen_definition["parent"] == "UGen"
    ):
        continue
    parent_definition = ugens[ugen_definition["parent"]]
    while "methods" not in parent_definition and parent_definition["parent"] != "UGen":
