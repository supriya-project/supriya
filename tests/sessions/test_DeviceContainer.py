...
@pytest.mark.parametrize(
    ...
    [
        ...
        AddRackScenario(
            ...
            - [None,
               [['/g_new', 1018, 0, 1015, 1019, 1, 1018],
                ['/s_new', 'supriya:patch-cable:2x2:replace', 1020, 2, 1019, 'in_', 18.0, 'out', 20.0],
        ...
        AddRackScenario(
            ...
            - ['/sync', 3]
            - [None, [['/c_set', 5, 1.0], ['/c_fill', 6, 2, 0.0]]]
            - [None, [['/c_set', 8, 1.0, 9, 0.0], ['/c_fill', 10, 2, 0.0]]]
            - [None,
               [['/g_new', 1007, 0, 1002, 1008, 0, 1007],
            ...
            - [None,
               [['/g_new', 1011, 0, 1008, 1012, 1, 1011],
                ['/s_new', 'supriya:zero:2', 1013, 2, 1012, 'out', 18.0],
                ['/s_new', 'supriya:channel-strip:2', 1014, 3, 1012, 'active', 'c8', 'gain', 'c9', 'out', 18.0],
