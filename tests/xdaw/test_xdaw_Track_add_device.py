...
def test_AudioEffect_1(synthdef_factory):
    ...
    assert device.graph_order == (2, 0, 0, 0, 4, 0)
...
def test_AudioEffect_2(synthdef_factory):
    ...
    assert device_one.graph_order == (2, 0, 0, 0, 4, 0)
    ...
    assert device_two.graph_order == (2, 0, 0, 0, 4, 1)
...
def test_AudioEffect_3(synthdef_factory):
    ...
    assert message.to_list() == [None, [[5, compiled_synthdefs, [None, bundle_contents]]]]
    time.sleep(0.1)
