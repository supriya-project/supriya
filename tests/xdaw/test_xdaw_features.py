        ...
        NODE TREE 1000 group (Context)
            1001 group (Tracks)
                1002 group (One)
                    ...
                    1011 group (Devices)
                        1012 group (Rack)
                            1013 mix/patch[gain]/2x2 (RackIn)
                            ...
                            1015 group (ChainContainer)
                                1016 group (Chain)
                                    ...
                                    1022 mixer/levels/2 (PostfaderLevels)
                                        out: 24.0, gate: 1.0, lag: 0.01
                            1014 mix/patch[hard,mix]/2x2 (RackOut)
        ...
        NODE TREE 1000 group (Context)
            1001 group (Tracks)
                1002 group (Track)
                    ...
                    1011 group (Devices)
                        1012 group (outer/a)
                            1013 mix/patch[gain]/8x8 (RackIn)
                            ...
                            1015 group (ChainContainer)
                                ...
                                1034 group (outer/a/b)
                                    ...
                                    1042 group (Devices)
                                        1043 group (inner/a)
                                            1044 mix/patch[gain]/8x8 (RackIn)
                                    ...
                                    1040 mixer/levels/8 (PostfaderLevels)
                                        out: 72.0, gate: 1.0, lag: 0.01
                            1014 mix/patch[hard,mix]/8x8 (RackOut)
                                active: 1.0, gate: 1.0, hard_gate: 1.0, in_: 32.0, lag: 0.01, mix: 1.0, out: 24.0
                        1092 group (outer/b)
                            1093 mix/patch[gain]/8x8 (RackIn)
                            ...
                            1095 group (ChainContainer)
                                ...
                                1114 group (outer/b/b)
                                    ...
                                    1122 group (Devices)
                                        1123 group (inner/b)
                                            1124 mix/patch[gain]/8x8 (RackIn)
                                    ...
                                    1120 mixer/levels/8 (PostfaderLevels)
                                        out: 184.0, gate: 1.0, lag: 0.01
                            1094 mix/patch[hard,mix]/8x8 (RackOut)
