...
def test_01(nonrealtime_paths):
    ...
    pytest.helpers.assert_soundfile_ok(
        nonrealtime_paths.output_file_path, exit_code, 1., 44100, 8)
...
def test_02(nonrealtime_paths):
    ...
    pytest.helpers.assert_soundfile_ok(
        nonrealtime_paths.output_file_path, exit_code, 300., 48000, 2)
...
def test_03(nonrealtime_paths):
    ...
    assert session.to_osc_bundles() == [
        supriya.osc.OscBundle(
            ...
            contents=(
                ...
                supriya.osc.OscMessage('/s_new', '448a8d487adfc99ec697033edc2a1227', 1000, 0, 0, 'duration', 1.0),
                )
            ),
        supriya.osc.OscBundle(
            timestamp=1.0,
    ...
    pytest.helpers.assert_soundfile_ok(
        nonrealtime_paths.output_file_path, exit_code, 1., 44100, 1)
