...
def test_manual_incommunicado():
    ...
    assert lists == [
        ...
        [14.0, [['/n_set', 1004, 'gate', 0], ['/n_free', 1001]]],
        [14.25, [['/n_free', 1000, 1002, 1003]]],
    ]
...
def test_nonrealtime():
    ...
    assert session.to_lists() == [
        ...
        [11.0, [['/n_set', 1004, 'amplitude', 1.0, 'frequency', 660]]],
        [
            11.5,
            [
                [
        ...
        [12.0, [['/n_set', 1004, 'amplitude', 1.0, 'frequency', 880]]],
        [
            12.25,
            [
                [
        ...
        [14.0, [['/n_set', 1001, 'gate', 0], ['/n_set', 1004, 'gate', 0]]],
        [14.25, [['/n_free', 1000, 1002, 1003], [0]]],
    ]
