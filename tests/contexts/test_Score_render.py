...
from supriya import default, output_path
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            / "e6beae761b2c8f192cfcd48948f0b51239699355b4450e640ffc97ec7243c4a4.aiff",
            8,
            3.0,
            44100,
        ),
        (
            ...
            lambda path: output_path
            / "fbd0f324690ab445771bfa1932339f2cd4fc023e5e79986854091e79f1139f94.aiff",
            8,
            1.5,
            44100,
        ),
        (
            ...
            lambda path: output_path
            / "31d5cda432402e03a4fdb507b479408d26eec2879f342e790d6c3ee825cab67d.aiff",
            2,
            2.5,
            44100,
        ),
        (
            ...
            lambda path: output_path
            / "b7b44173bb96829b38b0792ac209e2dc96e0d9022c322f4a011b533f32579743.aiff",
            2,
            3.0,
            44100,
        ),
        (
            ...
            lambda path: output_path
            / "c8561182c6faabda4ad0b10278fe1edb62306f1beca0eaeba82311d7e5020368.aiff",
            2,
            3.5,
            44100,
        ),
        ...
        (
            ...
            lambda path: output_path
            / "2140a1b747033ecdbeac8c656586ba444abf60a6e1c60362c6aa40d9481612b7.aiff",
            8,
            3.0,
            48000,
        ),
...
async def test_render(
    ...
    if actual_path is not None:
        ...
        with actual_path.open("rb") as file_pointer:
            ...
            assert (
                round(actual_frame_count / actual_sample_rate, 2) == expected_duration
            )
