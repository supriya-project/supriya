...
def test_nonrealtime_01a():
    ...
    assert session.to_lists() == [
        ...
        [24.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1008, 0, 0,
                'frequency', 1004],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1009, 0, 0,
                'frequency', 3003]]],
        ...
        [0.0, [
            *d_recv_commands,
            ...
            ['/s_new', '38a2c79fc9d58d06e361337163a4e80f', 1001, 3, 1000,
                'fade_time', 0.25, 'in_', 2],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1002, 0, 1000,
                'frequency', 1001, 'out', 2],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1003, 0, 1000,
                'frequency', 2001, 'out', 2],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1004, 0, 1000,
                'frequency', 3001, 'out', 2]]],
        [8.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1005, 0, 1000,
                'frequency', 1002, 'out', 2]]],
        [10.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1006, 0, 1000,
                'frequency', 2002, 'out', 2],
            ['/n_set', 1002, 'gate', 0],
            ['/n_set', 1003, 'gate', 0],
            ['/n_set', 1004, 'gate', 0]]],
        [12.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1007, 0, 1000,
                'frequency', 3002, 'out', 2]]],
        [16.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1008, 0, 1000,
                'frequency', 1003, 'out', 2]]],
        [18.0, [['/n_set', 1005, 'gate', 0]]],
        [20.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1009, 0, 1000,
                'frequency', 2003, 'out', 2],
            ['/n_set', 1006, 'gate', 0]]],
        [22.0, [['/n_set', 1007, 'gate', 0]]],
        [24.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1010, 0, 1000,
                'frequency', 1004, 'out', 2],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1011, 0, 1000,
                'frequency', 3003, 'out', 2]]],
        ...
        [0.0, [
            *d_recv_commands,
            ...
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1001, 0, 1000,
                'frequency', 2001],
            ['/g_new', 1002, 0, 0],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1003, 0, 1002,
                'frequency', 3001]]],
        [10.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1004, 0, 1000,
                'frequency', 2002],
            ...
            ['/n_set', 1003, 'gate', 0]]],
        [12.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1005, 0, 1002,
                'frequency', 3002]]],
        [20.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1006, 0, 1000,
                'frequency', 2003],
...
def test_nonrealtime_05a():
    ...
    assert session.to_lists() == [
        [0.0, [
            *d_recv_commands,
            ...
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1002, 0, 1000,
                'frequency', 2001],
            ['/g_new', 1003, 1, 0],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1004, 0, 1003,
                'frequency', 3001],
        ...
        [12.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1008, 0, 1000,
                'frequency', 2002],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1009, 0, 1003,
                'frequency', 4002]]],
        [20.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1010, 0, 1000,
                'frequency', 1003],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1011, 0, 1003,
                'frequency', 3003],
            ['/n_set', 1006, 'gate', 0],
            ['/n_set', 1007, 'gate', 0]]],
        [22.0, [
            ...
            ['/n_set', 1009, 'gate', 0]]],
        [24.0, [
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1012, 0, 1000,
                'frequency', 2003],
            ['/s_new', 'da0982184cc8fa54cf9d288a0fe1f6ca', 1013, 0, 1003,
                'frequency', 4003]]],
        [30.0, [
            ['/n_set', 1010, 'gate', 0],
            ['/n_set', 1011, 'gate', 0]]],
